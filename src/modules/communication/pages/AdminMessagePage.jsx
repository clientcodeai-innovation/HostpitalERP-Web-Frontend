...
export default function AdminMessagePage() {
  return (
    <div className="space-y-6">
      <PageHeader
        title="Messages"
        description="Communicate privately with patients and hospital staff."
      />
      <div className="flex flex-col md:flex-row gap-6 h-[600px]">
        ...
        <Card className="w-full md:w-1/3 flex flex-col">
          ...
          <div className="flex-1 overflow-y-auto">
            {[
              { name: 'Michael Clark', role: 'Patient', active: true },
        ...
        <Card className="w-full md:w-2/3 flex flex-col">
          <div className="p-4 border-b border-border flex items-center gap-3">
            ...
            <div>
              <div className="font-semibold text-foreground">Michael Clark</div>
          ...
          <CardContent className="flex-1 p-4 flex flex-col gap-4 overflow-y-auto bg-muted/10">
            ...
            <div className="flex justify-end">
              <div className="bg-primary text-primary-foreground text-sm p-3 rounded-lg rounded-tr-none max-w-[80%] shadow-sm">
                Hi Michael. I have reviewed them and everything looks normal. Please continue the prescribed medication.
                <div className="text-[10px] opacity-70 text-right mt-1">10:45 AM</div>
              </div>
            </div>
          </CardContent>
