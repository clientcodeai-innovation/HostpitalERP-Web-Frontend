...
const patients = [
  { id: 'P-1001', name: 'Aarav Sharma', age: '3Y 2M', phone: '+91 98765 43210', guardian: 'Rajesh Sharma', lastVisit: '12 Jul 2026', status: 'Active' },
  { id: 'P-1002', name: 'Diya Patel', age: '1Y 8M', phone: '+91 87654 32109', guardian: 'Priya Patel', lastVisit: '10 Jul 2026', status: 'Active' },
  { id: 'P-1003', name: 'Kabir Singh', age: '5Y 0M', phone: '+91 76543 21098', guardian: 'Manpreet Singh', lastVisit: '08 Jul 2026', status: 'Follow-up' },
  { id: 'P-1004', name: 'Ananya Gupta', age: '0Y 6M', phone: '+91 65432 10987', guardian: 'Neha Gupta', lastVisit: '05 Jul 2026', status: 'Active' },
  { id: 'P-1005', name: 'Rohan Verma', age: '4Y 11M', phone: '+91 54321 09876', guardian: 'Amit Verma', lastVisit: '01 Jul 2026', status: 'Discharged' },
  { id: 'P-1006', name: 'Ishaan Kumar', age: '2Y 3M', phone: '+91 98765 11111', guardian: 'Suresh Kumar', lastVisit: '14 Jul 2026', status: 'Active' },
];
  ...
  return (
    <div className="space-y-6">
        ...
        <CardContent className="p-4">
          <div className="flex flex-col sm:flex-row gap-3">
            <div className="relative flex-1">
              ...
              <Input placeholder="Search by name, phone, ID..." className="pl-10" />
            </div>
      ...
      <div className="flex items-center gap-3 p-3 rounded-lg bg-destructive/10 border border-destructive/20 text-sm">
        ...
        <span className="text-foreground">Possible duplicate detected: <strong>Aarav Sharma</strong> â€” Phone +91 98765 43210 already exists.</span>
