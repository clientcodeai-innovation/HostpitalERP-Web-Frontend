...
export default function ChatWidget() {
  ...
  const [history, setHistory] = useState([
    {
      type: 'bot',
      text: "ðŸ™ Welcome to Hari Om Homeo Clinic\n\nHow can we assist you today?",
      options: [
  ...
  const handleOptionClick = (option) => {
    ...
    if (option.id === 1) {
      newHistory.push({
        type: 'bot',
        text: "Thanks â€” you chose to book an OPD appointment.\n\nPlease select your preferred department:",
        options: [
          { id: 11, label: "ðŸ‘¶ Pediatrician & Neonatologist (Dr. Vijay)" },
          { id: 12, label: "ðŸ‘©â€âš•ï¸ Gynaecologist & Obstetrics (Dr. Sweta)" },
          { id: 13, label: "ðŸ‘¨â€ðŸ’¼ðŸ‘©â€âš•ï¸ Infertility Specialist (Dr. Vijay & Dr. Sweta)" }
        ]
      });
      setStep(2);
    } else {
